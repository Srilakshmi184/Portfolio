...
<head>
  ...
  <title>SRILAKSHMI BH | Exp:1</title>
...
<body>
  ...
  <!-- Navbar -->
  <header>
    <h1 class="logo">SRILAKSHMI BH</h1>
    <nav>
    ...
    <div class="hero-content">
        <div class="hero-text">
          <div class="hero-image">
            <img src="212224100057.png" alt="Profile Picture">
          </div>
        <h2>Hey there, I'm <span>SRILAKSHMI BH</span></h2>
...
<div class="skill-box">
  ...
  <section id="contact" class="section light">
    <h2>Contact Me</h2>
    <p>Email: luckillly.123@gmail.com</p>
    <p>Location:Chennai,India</p>
  </section>

  <!-- Footer -->
  <footer>
  <p>© 2026 SRILAKSHMI BH All Rights Reserved.</p>
